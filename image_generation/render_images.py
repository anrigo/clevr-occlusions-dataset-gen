  ...
  for i in range(num_objects):
    ...
    while True:
      ...
      if i % 2 == 0:
        ...
        # just placed an object, now place the next be close to it to create occlusions
        # randomly sample near the previous object
        
        # previous object coordinates
        xp, yp, rp = positions[i-1]
        ...
        # rotate point so that it is behind or in front of the preious object
        # with respect to the camera point of view
        
        # translate new object to the origin
        x -= xp
        y -= yp
        ...
        cos_ = math.cos(theta)
        sin_ = math.sin(theta)
        # rotate it with respect to the origin
        xnew = x * cos_ - y * sin_
        ynew = x * sin_ + y * cos_
